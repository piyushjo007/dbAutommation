CREATE OR REPLACE PROCEDURE ora_error_mail233 (l_smtp_server IN varchar2,l_smtp_port IN number,l_wallet_dir IN varchar2,l_from IN varchar2,l_to IN varchar2,l_intrv IN number,l_password IN varchar2 ,l_user IN varchar2 )
